...
export interface ApiBlogPageBlogPage extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    blocks: Schema.Attribute.DynamicZone<
      ['blocks.cta-command-line', 'blocks.cta']
    > &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
...
export interface ApiRestaurantRestaurant extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    price: Schema.Attribute.Enumeration<['p1', 'p2', 'p3', 'p4']> &
      Schema.Attribute.Required &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: false;
    ...
    information: Schema.Attribute.Component<'restaurant.information', false> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiRestaurantPageRestaurantPage
  ...
  attributes: {
    ...
    PlaceText: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
    ...
    restaurantsPerPage: Schema.Attribute.Integer &
      Schema.Attribute.Required &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: false;
    ...
    blocks: Schema.Attribute.DynamicZone<['blocks.cta']> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
